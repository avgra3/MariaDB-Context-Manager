...
class TestConversions(unittest.TestCase):
    def test_convert_to_string(self):
        ...
        self.assertIsInstance(
            result, 
            str, 
            f"Should be a string. Is of type `{type(result)}`"
        )
    ...
    def test_convert_to_int(self):
        ...
        self.assertIsInstance(
            result,
            int, 
            "Should be a string. Is of type `{type(result)}`"
        )
    ...
    def test_convert_to_float(self):
        ...
        self.assertIsInstance(
            result, 
            float,
            "Should be a float. Is of type `{type(result)}`"
        )
    ...
    def test_convert_to_set(self):
        ...
        self.assertIsInstance(
            result, 
            set,
            "Should be a set. Is of type `{type(result)}`"
        )
